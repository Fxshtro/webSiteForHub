        ...
        <div>
            <div className="glass md:w-[461px] w-[361px] !bg-[#9F9F9F20] px-[21px] pt-[16px] md:pb-9 pb-6 ![box-shadow:0px_0px_250px_#ffffff10]">
                <div className="flex justify-between">
                    ...
                    <Image src="/i.svg" width={30} height={30} alt="" className="cursor-pointer hover:opacity-60"/>
                </div>
                ...
                <div className="font-unbounded2 md:text-[36px] text-[26px] text-center md:mt-8 mt-4 text-shadow-lg text-shadow-[#000000] hover:underline cursor-pointer">+7 (988) 892-70-02</div>
